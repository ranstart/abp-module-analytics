...
namespace Ran.Analytics
{
    ...
    {
        private readonly IVisitorAppService _sampleAppService;
        private readonly IIdentityModelAuthenticationService _authenticationService;
        private readonly IConfiguration _configuration;

        public ClientDemoService(
            IVisitorAppService sampleAppService, 
        ...
        private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var url = _configuration["RemoteServices:Analytics:BaseUrl"] +
                          "api/Analytics/sample/authorized";
